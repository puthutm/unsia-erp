-- core_db: 000021_create_inbox_events.up.sql
-- Inbox pattern: consumer menerima event, cek duplikat via event_key, proses idempotent
...
CREATE TABLE inbox_events (
    ...
    consumer_module     VARCHAR(50) NOT NULL DEFAULT 'core',
