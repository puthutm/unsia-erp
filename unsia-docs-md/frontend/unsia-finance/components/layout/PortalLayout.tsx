...
const navigation = [
  ...
  { name: "Invoice", href: "/invoice", icon: "file-text" },
  { name: "Pembayaran", href: "/payment", icon: "credit-card" },
  { name: "Komponen", href: "/component", icon: "package" },
  { name: "Laporan", href: "/report", icon: "bar-chart" },
];

const modules = [
  { id: "pmb", name: "PMB", href: FRONTEND_URLS.pmb, icon: "graduation-cap" },
  { id: "finance", name: "Keuangan", href: "/", icon: "wallet" },
  { id: "academic", name: "Akademik", href: FRONTEND_URLS.academic, icon: "book" },
